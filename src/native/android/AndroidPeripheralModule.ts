...
// Type definition for the native Android module
interface AndroidPeripheralNativeModule {
  // Capabilities
...
export class AndroidPeripheralModule implements PlatformPeripheralAdapter {
  private nativeModule: AndroidPeripheralNativeModule;
  private eventEmitter: NativeEventEmitter;
  private eventListeners: Map<PeripheralEvent, Set<(data: PeripheralEventData) => void>> = new Map();

  constructor() {
    if (Platform.OS !== 'android') {
      throw new Error('AndroidPeripheralModule can only be used on Android');
    }

    // Get the native module
    const { AndroidBlePeripheral } = NativeModules;
    if (!AndroidBlePeripheral) {
      throw new Error('AndroidBlePeripheral native module not found. Make sure it is properly linked.');
    }

    this.nativeModule = AndroidBlePeripheral as AndroidPeripheralNativeModule;
    this.eventEmitter = new NativeEventEmitter(AndroidBlePeripheral);
  ...
  public async getCapabilities(): Promise<PeripheralCapabilities> {
    try {
      ...
      console.error('Failed to get Android peripheral capabilities:', error);
      throw error;
    }
  }
  ...
  public async isSupported(): Promise<boolean> {
    try {
      ...
      console.error('Failed to check Android peripheral support:', error);
      return false;
    }
  }
  ...
  public async startAdvertising(options: AdvertisingOptions): Promise<void> {
    try {
      const androidOptions = {
        ...
        txPowerLevel: options.txPowerLevel,
        advertisingMode: options.advertisingMode,
        isConnectable: options.isConnectable,
        timeout: options.timeout
      };

      await this.nativeModule.startAdvertising(androidOptions);
    } catch (error) {
      console.error('Failed to start Android advertising:', error);
      throw error;
    }
  }
  ...
  public async stopAdvertising(): Promise<void> {
    try {
      ...
      console.error('Failed to stop Android advertising:', error);
      throw error;
    }
  }
  ...
  public async isAdvertising(): Promise<boolean> {
    try {
      ...
      console.error('Failed to check Android advertising status:', error);
      return false;
    }
  }
  ...
  public async startGattServer(services: GattService[]): Promise<void> {
    try {
      const androidServices = services.map(service => ({
        uuid: service.uuid,
        type: service.type,
      ...
      await this.nativeModule.startGattServer(androidServices);
    } catch (error) {
      console.error('Failed to start Android GATT server:', error);
      throw error;
    }
  }
  ...
  public async stopGattServer(): Promise<void> {
    try {
      ...
      console.error('Failed to stop Android GATT server:', error);
      throw error;
    }
  }
  ...
  public async addService(service: GattService): Promise<void> {
    try {
      ...
      await this.nativeModule.addService(androidService);
    } catch (error) {
      console.error('Failed to add Android service:', error);
      throw error;
    }
  }
  ...
  public async removeService(serviceUuid: string): Promise<void> {
    try {
      ...
      console.error('Failed to remove Android service:', error);
      throw error;
    }
  }
  ...
  public async getConnectedClients(): Promise<ConnectedClient[]> {
    try {
      ...
      console.error('Failed to get Android connected clients:', error);
      throw error;
    }
  }
  ...
  public async disconnectClient(clientId: string): Promise<void> {
    try {
      ...
      console.error('Failed to disconnect Android client:', error);
      throw error;
    }
  }
  ...
  public async sendIndication(clientId: string, serviceUuid: string, characteristicUuid: string, data: ArrayBuffer): Promise<void> {
    try {
      ...
      console.error('Failed to send Android indication:', error);
      throw error;
    }
  }
  ...
  public async respondToReadRequest(request: CharacteristicRequest, response: CharacteristicResponse): Promise<void> {
    try {
      ...
      console.error('Failed to respond to Android read request:', error);
      throw error;
    }
  }
  ...
  public async respondToWriteRequest(request: CharacteristicRequest, response: CharacteristicResponse): Promise<void> {
    try {
      ...
      console.error('Failed to respond to Android write request:', error);
      throw error;
    }
  }
  ...
  public async getState(): Promise<PeripheralState> {
    try {
      ...
      console.error('Failed to get Android peripheral state:', error);
      throw error;
    }
  }
  ...
  public async destroy(): Promise<void> {
    try {
      ...
      console.error('Error during Android peripheral cleanup:', error);
      throw error;
    }
  }
}